...
/// <summary>
/// Relationships were added to an item
/// </summary>
public class ItemRelationshipsAddedEvent : DomainEventBase, IDomainEvent
{
    ...
    /// </summary>
    public IEnumerable<RelationshipEntry> AddedRelationships { get; init; } = Enumerable.Empty<RelationshipEntry>();
}
